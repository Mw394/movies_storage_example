...
class _AddMovieFormState extends State<AddMovieForm> {
  ...
  Movie movie = Movie(false, "title", "year", "runtime", "genre", "director", "actors", "plot", "country", "awards", "Inception");
            ...
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  if (form!.validate()) {
                    form.save();
                    Provider.of<AppState>(context, listen: false).addMoviePathProvider(movie: movie);
